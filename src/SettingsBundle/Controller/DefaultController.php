...
use SettingsBundle\Service\MessageGenerator;
...
class DefaultController extends Controller
{
        ...
        if ($this->getUser())
        {
            ...
            if ($form->isSubmitted())
            {
            ...
            else
                {
                    ...
                    {
                        if($newEmail && ($user->getEmail()!= $newEmail->getEmail()))
                        {
                            $this->get('session')->getFlashBag()->clear();
    ...
    public function formAction(Request $request)
    {
        ...
        return $this->render("SettingsBundle:Default:form.html.twig",array("form"=>$form->createView()));
